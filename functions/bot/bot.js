...
const bot = new Telegraf(process.env.BOT_TOKEN); const apiKey = "j9iuzH5Rz5TfnIUokQoZ9jLF";
...
async function generatePrediction(pair, time) { try { const encodedPair = encodeURIComponent(pair); const url = https://fcsapi.com/api-v3/forex/latest?symbol=${encodedPair}&access_key=${apiKey};
...
${emoji.repeat(5)} 𝗣𝗥𝗘𝗗𝗜𝗖𝗧𝗜𝗢𝗡: ${trend} ${trendIcon}
𝗣𝗔𝗜𝗥: ${pair}
𝗧𝗜𝗠𝗘𝗙𝗥𝗔𝗠𝗘: ${time}`.trim();
